      ...
      <Header />
       ...
       <div className='flex flex-col h-main-hero w-full relative justify-between mt-8'>
          <img className="absolute h-full object-cover z-10
                            tv:object-hero-big-screen desktop:object-hero-big-screen  laptop:object-hero-big-screen  s-laptop:object-left-top tablet:object-left-top  mobile:object-left-top" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + heroBgImg}  alt=""/>
      ...
      <div className={`flex flex-col h-auto w-fill-available bg-navy-blue pb-8`} style={{ boxShadow: 'inset 0 0px 10px #000' }}>
        ...
        <div class="relative flex overflow-x-hidden gap-8">
          <div className="flex py-2 justify-around flex-wrap gap-6">
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + RPI_LOGO} alt=""  />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + STS_LOGO} alt="" />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + NCBI_LOGO} alt="" />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + IA_LABS_LOGO} alt="" />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + NVIBE_LOGO} alt="" />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + CRNA_LOGO} alt="" />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + PIXELSPACE_LOGO} alt="" />
            <img className="flex justify-center h-24 w-36 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + OKEENEA_LOGO} alt="" />
          </div>
        </div>
      </div>
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}  
      <div className="flex flex-col w-full h-auto bg-light-grey-bg py-28 
          ...
          <div className="flex flex-row flex-wrap w-full h-auto
            ...
            <div className="flex h-auto py-12
              ...
              <img className="h-phone w-fit" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + iPhone14_First} alt="" />
        ...
        <div className="flex flex-col w-full h-auto bg-white py-28
          ...
          <div className="flex flex-row flex-wrap w-full h-auto">
            <div className="flex justify-center  min-h-[475px]  desktop:basis-1/2 laptop:basis-full s-laptop:basis-full tablet-basis:full  laptop:pb-6 s-laptop:pb-6 tablet:pb-6 mobile:pb-6">
              <img className="h-section-img max-h-[475px] w-auto rounded-section-image" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + Group_Intro} alt=""/> 
            </div>
        ...
        <div className="flex flex-col w-full h-auto bg-white py-28 
          ...
          <div className="flex flex-row  flex-wrap justify-around w-full h-auto">
            <div className="flex flex-col basis-96 h-auto pb-4"> 
              <img className="w-10/12" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + features1Img} alt="" /> 
            ...
            <div className="flex flex-col basis-96 h-auto pb-4"> 
              <img className="w-10/12" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + features2Img} alt="" /> 
            ...
            <div className="flex flex-col basis-96 h-auto pb-4"> 
              <img className="w-10/12" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + features3Img} alt="" /> 
