  ...
  return (
    <>
      <Header />
       ...
       {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className='flex flex-col tv:h-main-hero-big desktop:h-main-hero laptop:h-main-hero s-laptop:h-main-hero tablet:h-main-hero mobile:h-main-hero w-full relative justify-between mt-8'>
          <img className="absolute h-full object-cover z-10 tv:w-[100%]
                            tv:object-hero-big-screen desktop:object-hero-big-screen  laptop:object-hero-big-screen  s-laptop:object-left-top tablet:object-left-top  mobile:object-left-top" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + heroBgImg}  alt="Picture of a hand holding up a phone running Soundscape Community with panels illustrating what is being called out. In the background there are people in a park."/>
          <div className="flex flex-col z-30 gap-6 mx-20
              ...
              <h2 className="w-full  text-white text-hero-title font-bold leading-none
                ...
                <span  className="tv:text-hero-title desktop:text-hero-title laptop:text-hero-title-sub s-laptop:text-hero-title-sub tablet:text-hero-title-sub mobile:text-hero-title-sub">Community</span> 
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div id="consortium" className={`flex flex-col h-auto w-fill-available bg-navy-blue pb-8`} style={{ boxShadow: 'inset 0 0px 10px #000' }}>
          <h2 className="w-full text-white font-bold text-3xl text-center my-8 leading-8" >Meet the Soundscape Consortium</h2>
          <div class="relative flex overflow-x-hidden gap-8">
            <div className="flex py-2 justify-around flex-wrap gap-6">
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + NCBI_LOGO} alt="National Council for the Blind of Ireland Logo" />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + IA_LABS_LOGO} alt="Inclusion and Accessibility Labs Logo" />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + RPI_LOGO} alt="Rensselaer Polytechnic Institute Logo"  />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + STS_LOGO} alt="Simplicity Tech Solutions Logo" />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + NVIBE_LOGO} alt="N-Vibe Logo" />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + CRNA_LOGO} alt="Capital Region Nordic Alliance Logo" />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + PIXELSPACE_LOGO} alt="Pixelspace Logo" />
              <img className="flex justify-center h-24 w-40 mx-12" src={ (WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" ) + OKEENEA_LOGO} alt="Okeenea Logo" />
            </div>
          </div>
        </div>
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}  
        <div className="flex flex-col w-full h-auto bg-light-grey-bg py-28 
          ...
          <div className="flex flex-row flex-wrap w-full h-auto
            ...
            <div className="flex h-auto py-12
              ...
              <img className="h-phone w-fit" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + iPhone14_First} alt="Image of Soundscape Community running on an iphone displaying a location screen with a map and task options" />
        ...
        <div className="flex flex-col w-full h-auto bg-white py-28
          ...
          <div className="flex flex-row flex-wrap w-full h-auto">
            <div className="flex justify-center max-h-[475px]  desktop:basis-1/2 laptop:basis-full s-laptop:basis-full tablet-basis:full  laptop:pb-6 s-laptop:pb-6 tablet:pb-6 mobile:pb-6">
              <img className="image-sizing w-[80%] max-h-[400px] max-w-[712px] rounded-section-image" src={(WEBSITE_ENVIORNMENT === "development" ? "http://localhost:3000" : "" )  + Group_Intro} alt="Image of a woman wearing shades and headphones walking down a busy street using Soundscape Community. With supplemental white speakers surrounding her head to show the spatial audio from the application"/> 
            </div>
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-navy-blue py-28 
            ...
            <div className="flex justify-center items-center max-h-[475px] desktop:basis-7/12 laptop:basis-full laptop:w-full mb-8 s-laptop:basis-full s-laptop:w-full tablet:basis-full tablet:w-full desktop:pl-10 mobile:basis-full">
              <iframe className=" video-sizing w-[80%] max-h-[400px] max-w-[712px]  rounded-section-image" src="https://www.youtube.com/embed/QR_2eF0YjM0?cc_load_policy=1&start=1" title="Youtube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
