  ...
  return (
   <>
      <header className="flex h-header w-full fixed top-0 left-0 z-50 py-4 items-center justify-between bg-soundscape-blue-bg 
        ...
        >
          <FiMenu alt="Image of a Hamburger Menu" aria-label="Image of a Hamburger Menu" aria-describedby="hamburger-menu" title="Navigation Menu Icon" className="2xl:hidden xl:hidden lg:flex md:flex sm:flex xs:flex text-white" style={{ 'cursor': 'pointer'}} color="#fff" fill="#fff" size={"2.5rem"} onClick={() => { setShowNavDropdown(false)}} />
